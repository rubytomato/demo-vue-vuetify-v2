...
const store = new Vuex.Store({
  ...
  state: {
    components: [
      ...
      { name: 'GridP1', path: '/grid/p1', active: 'primary' },
      { name: 'GridP2', path: '/grid/p2', active: 'primary' },
      { name: 'GridP3', path: '/grid/p3', active: 'primary' },
      { name: 'GridP4', path: '/grid/p4', active: 'primary' },
      { name: 'GridP5', path: '/grid/p5', active: 'primary' },
